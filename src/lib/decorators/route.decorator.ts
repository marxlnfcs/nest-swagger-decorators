...
export function ApiAll(path?: IApiRouteLike, options?: Omit<IApiRouteOptions, 'path'>|false, status?: number): MethodDecorator;
export function ApiAll(pathOrOptionsOrStatus?: IApiRouteLike|IApiRouteOptions|number|false, statusOrOptions?: Omit<IApiRouteOptions, 'path'>|number|false, statusNumber?: number): MethodDecorator {
...
export function ApiGet(path?: IApiRouteLike, options?: Omit<IApiRouteOptions, 'path'>|false, status?: number): MethodDecorator;
export function ApiGet(pathOrOptionsOrStatus?: IApiRouteLike|IApiRouteOptions|number|false, statusOrOptions?: Omit<IApiRouteOptions, 'path'>|number|false, statusNumber?: number): MethodDecorator {
...
export function ApiPost(path?: IApiRouteLike, options?: Omit<IApiRouteOptions, 'path'>|false, status?: number): MethodDecorator;
export function ApiPost(pathOrOptionsOrStatus?: IApiRouteLike|IApiRouteOptions|number|false, statusOrOptions?: Omit<IApiRouteOptions, 'path'>|number|false, statusNumber?: number): MethodDecorator {
...
export function ApiPatch(path?: IApiRouteLike, options?: Omit<IApiRouteOptions, 'path'>|false, status?: number): MethodDecorator;
export function ApiPatch(pathOrOptionsOrStatus?: IApiRouteLike|IApiRouteOptions|number|false, statusOrOptions?: Omit<IApiRouteOptions, 'path'>|number|false, statusNumber?: number): MethodDecorator {
...
export function ApiPut(path?: IApiRouteLike, options?: Omit<IApiRouteOptions, 'path'>|false, status?: number): MethodDecorator;
export function ApiPut(pathOrOptionsOrStatus?: IApiRouteLike|IApiRouteOptions|number|false, statusOrOptions?: Omit<IApiRouteOptions, 'path'>|number|false, statusNumber?: number): MethodDecorator {
...
export function ApiDelete(path?: IApiRouteLike, options?: Omit<IApiRouteOptions, 'path'>|false, status?: number): MethodDecorator;
export function ApiDelete(pathOrOptionsOrStatus?: IApiRouteLike|IApiRouteOptions|number|false, statusOrOptions?: Omit<IApiRouteOptions, 'path'>|number|false, statusNumber?: number): MethodDecorator {
...
export function ApiHead(path?: IApiRouteLike, options?: Omit<IApiRouteOptions, 'path'>|false, status?: number): MethodDecorator;
export function ApiHead(pathOrOptionsOrStatus?: IApiRouteLike|IApiRouteOptions|number|false, statusOrOptions?: Omit<IApiRouteOptions, 'path'>|number|false, statusNumber?: number): MethodDecorator {
...
export function ApiOptions(path?: IApiRouteLike, options?: Omit<IApiRouteOptions, 'path'>|false, status?: number): MethodDecorator;
export function ApiOptions(pathOrOptionsOrStatus?: IApiRouteLike|IApiRouteOptions|number|false, statusOrOptions?: Omit<IApiRouteOptions, 'path'>|number|false, statusNumber?: number): MethodDecorator {
  return ApiRoute(RequestMethod.OPTIONS, pathOrOptionsOrStatus, statusOrOptions, statusNumber);
}

/** @internal */
function ApiRoute(method: RequestMethod, pathOrStatusOrOptions?: IApiRouteLike|IApiRouteOptions|false|number, statusOrOptions?: Omit<IApiRouteOptions, 'path'>|false|number, statusNumber?: number): MethodDecorator {
  return function(target, propertyKey, descriptor) {

    // resolve path and options
    const options = extractOptions<IApiRouteOptions>(pathOrStatusOrOptions, statusOrOptions);
    const path = extractPath(pathOrStatusOrOptions, options ? options.path : null);
    const status = extractStatus(method, pathOrStatusOrOptions, statusOrOptions, isObject(options as any) && isObject((options as any)?.response) ? (options as any).response.status : null, statusNumber);
